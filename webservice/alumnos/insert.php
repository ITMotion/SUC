<?php 
/**********************************************************
* @description: Crea un alumno en la base de datos desde la aplicación Android
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	//crea el alumno en la base de datos y se regresa un valor que nos dirá si se tuvo exito o no
	$status = $db->insertAlumno($alumno['nombres'], $alumno['paterno'], $alumno['materno'], $alumno['grupo']);
